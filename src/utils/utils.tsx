 ...
 * return {Array}  数组类型
 */
const indexToArray = (pathStr: string) =>
 ...
 */
const getCloneItem = (index: string, cards: array) => {
 ...
 */
const setInfo = (arrPath: array, treeData: array, param: object) => {
 ...
 */
const isChildrenPath = (dragIndex: string, hoverIndex: string) => {
 ...
 * @param {String} index
 */
const generatePathArr = (index: string) => {
  let arr: array = [];
